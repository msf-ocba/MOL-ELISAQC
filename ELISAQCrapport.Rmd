...
params:
  kit:
    label: "Selectionner le kit ELISA:"
    value: "Rougeole (IgM - NP)"
    input: select
    choices: [Rougeole (IgM - NP), Rubéole (IgM - GP), Coqueluche (IgG - PT)]
  ids:
    label: "Selectionner le dossier avec les identifiants des échantillons:"
    buttonLabel: "Télécharger"
    placeholder: "Téléchargement en cours"
    value: "./Data/SampleIDs_QCpass.csv"
    input: file
  resultats:
    label: "Selectionner le dossier avec les résultats bruts du lecteur ELISA:"
    buttonLabel: "Télécharger"
    placeholder: "Téléchargement en cours"
    value: "./Data/ExampleData_QCpass.csv"
    input: file
  refmaison:
    label: "Selectionner le dossier avec les valeurs de référence pour controles de maison:"
    buttonLabel: "Télécharger"
    placeholder: "Téléchargement en cours"
...
author: "Projet MOL: laboratoire mobile"
...
Ce rapport résume les résultats et l´évaluation du contrôle de qualité de la série de plaque ELISA EUROIMMUN pour le kit **`r params$kit`** effectuée à **`r elisa_timestamp`** par l´operateur **`r params$operateur`**.
...
setnames(qcout, old = c("PID", "Mean_DOD", "Mean_RQ", "SD_DOD", "QC_cvpass", "QCpass"), 
         new = c("Controle", "DO", "Rapport", "Écart type", "CV reussi", "CQ reussi"))
