...
params:
  username:
    ...
    value: "Amy.Mikhail@barcelona.msf.org"
    input: text
  pwd:
    label: "Mot de passe Go.Data:"
    value: "5crubber5crubber"
    input: password
  url:
    label: "URL Go.Data:"
...
### Source functions:
source("../Functions/endstring.R")
source("../Functions/list2vector.R")
source("../Functions/null2na.R")
source("../Functions/extract_ods.R")
source("../Functions/extract_dtstamp.R")
source("../Functions/label_elisaresults.R")
source("../Functions/calculate_ratios.R")
source("../Functions/calculate_standardcurve.R")
source("../Functions/calculate_cv.R")
source("../Functions/runqc_ratios.R")
source("../Functions/runqc_standardcurve.R")
source("../Functions/create_platemap.R")
source("../Functions/qc_check.R")
source("../Functions/export_labresults.R")
source("../Functions/godata_getids.R")
source("../Functions/godata_updatelab.R")
source("../Functions/godata_getcaselist.R")
source("../Functions/godata_getlablist.R")
source("../Functions/create_linelist.R")
source("../Functions/knit_params_conditional.R")
source("../Functions/run_interactive.R")
