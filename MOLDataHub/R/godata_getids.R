...
#' @md
#'  
#' @param url Character string of Go.Data instance URL
#' @param username The email address the user uses to login to Go.Data
#' @param password The password the user uses to login to Go.Data 
#' 
#' @returns list of one-time connection token, internal user and outbreak IDs 
#' 
